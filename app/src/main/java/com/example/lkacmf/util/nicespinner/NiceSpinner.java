package com.example.lkacmf.util.nicespinner;
...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, org.angmarch.views.R.styleable.NiceSpinner);
        int defaultPadding = resources.getDimensionPixelSize(org.angmarch.views.R.dimen.one_and_a_half_grid_unit);

        setGravity(Gravity.CENTER_VERTICAL | Gravity.START);
        setPadding(12, 0, 0, 0);
        setClickable(true);
        backgroundSelector = typedArray.getResourceId(org.angmarch.views.R.styleable.NiceSpinner_backgroundSelector, org.angmarch.views.R.drawable.selector);
        ...
        isArrowHidden = typedArray.getBoolean(org.angmarch.views.R.styleable.NiceSpinner_hideArrow, false);
        arrowDrawableTint = typedArray.getColor(org.angmarch.views.R.styleable.NiceSpinner_arrowTint, getResources().getColor(android.R.color.black));
        arrowDrawableResId = typedArray.getResourceId(org.angmarch.views.R.styleable.NiceSpinner_arrowDrawable, org.angmarch.views.R.drawable.arrow);
        dropDownListPaddingBottom =
                typedArray.getDimensionPixelSize(org.angmarch.views.R.styleable.NiceSpinner_dropDownListPaddingBottom, 0);
        horizontalAlignment = PopUpTextAlignment.fromId(
                typedArray.getInt(org.angmarch.views.R.styleable.NiceSpinner_popupTextAlignment, PopUpTextAlignment.CENTER.ordinal())
        );

        CharSequence[] entries = typedArray.getTextArray(org.angmarch.views.R.styleable.NiceSpinner_entries);
        if (entries != null) {
    ...
    public void setArrowDrawable(@DrawableRes @ColorRes int drawableId) {
        ...
        arrowDrawable = initArrowDrawable(org.angmarch.views.R.drawable.arrow);
        setArrowDrawableOrHide(arrowDrawable);
    }
    ...
    public <T> void attachDataSource(@NonNull List<T> list) {
        adapter = new NiceSpinnerAdapter<>(getContext(), list, org.angmarch.views.R.color.light_gray, backgroundSelector, spinnerTextFormatter, horizontalAlignment);
