...
public class BaseTextView extends LinearLayout {
    ...
    private void initAttributes() {
        if(attrs!=null){
            ...
            if (typedArray != null) {
                tvTitle = typedArray.getString(R.styleable.BaseTextView_header_title);
                isTittle=typedArray.getBoolean(R.styleable.BaseTextView_header_is_title_visiable,true);
                isleftIv=typedArray.getBoolean(R.styleable.BaseTextView_header_is_left_iv_visiable,true);
                typedArray.recycle();
            }
        }
        initView();
    ...
    public void initView(){
        LayoutInflater.from(MyApplication.context).inflate(R.layout.basetextview_item, this, true);
